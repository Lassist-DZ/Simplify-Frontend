...
const Footer = () => {
  return (
    <footer className="bg-[#F0F0F0] py-8 px-20  items-center w-full ">
      <center>
        <SimplifyLogo />
      </center>
...
Poppins] text-lg text pb-3"
        ...
        <div className="w-[304px] bg-black rounded-xl text-white h-[184px] p-4 flex flex-col justify-between">
          {/* Title */}
